-- FINAL FIX: Update calculate_timesheet_hours with corrected employee settings lookup
...
BEGIN
    ...
    -- FIXED: Get employee settings with PROPER existence check
    ...
    IF employee_lunch_type IS NOT NULL THEN
        ...
        -- Get full employee settings record
