-- Remove overtime_calculation field from company_settings and employee_settings tables
ALTER TABLE public.company_settings DROP COLUMN IF EXISTS overtime_calculation;
ALTER TABLE public.employee_settings DROP COLUMN IF EXISTS overtime_calculation;

-- Update the calculate_timesheet_hours trigger to always use "dopo ore standard" logic
