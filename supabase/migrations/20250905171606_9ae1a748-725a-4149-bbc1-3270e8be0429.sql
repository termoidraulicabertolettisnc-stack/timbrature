-- Add 'disabilitato' option to meal_voucher_type enum
ALTER TYPE meal_voucher_type ADD VALUE 'disabilitato';

-- Update the calculate_timesheet_hours function to handle disabled meal vouchers
