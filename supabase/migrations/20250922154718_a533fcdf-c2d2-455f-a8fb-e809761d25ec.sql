-- Drop existing trigger and create corrected version with data migration

-- Drop the existing trigger first
DROP TRIGGER IF EXISTS recalculate_timesheet_hours_on_session_change ON public.timesheet_sessions;

-- Drop and recreate the function with correct variable naming
...
BEGIN
    ...
    LOOP
        ...
        -- Calculate night hours for this session (simplified)
    ...
    -- Calculate day info for overtime using first session start time
