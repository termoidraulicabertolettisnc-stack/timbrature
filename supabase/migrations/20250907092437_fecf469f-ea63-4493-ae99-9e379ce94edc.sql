-- Fix della funzione calculate_timesheet_hours per gestire correttamente il sabato
...
BEGIN
    ...
    -- CORREZIONE PRINCIPALE: Calcola ore straordinarie correttamente per il sabato
    IF is_saturday THEN
