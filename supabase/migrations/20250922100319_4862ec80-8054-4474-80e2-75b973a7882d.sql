-- Create CORRECTED version of calculate_timesheet_hours with detailed logging
...
BEGIN
    ...
    -- FIXED: Get employee settings with CORRECTED date-based lookup
    -- BUG WAS HERE: We need to use NEW.date, not timesheet_rec.date
    ...
    -- FIXED: Determine lunch break settings with CORRECTED priority and explicit schema references
