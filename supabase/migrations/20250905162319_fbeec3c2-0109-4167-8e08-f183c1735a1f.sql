-- Add saturday_hourly_rate field to company_settings and employee_settings tables
ALTER TABLE public.company_settings 
ADD COLUMN saturday_hourly_rate numeric DEFAULT 10.00;

ALTER TABLE public.employee_settings 
ADD COLUMN saturday_hourly_rate numeric DEFAULT NULL;

-- Update the calculate_timesheet_hours function to handle Saturday calculations
