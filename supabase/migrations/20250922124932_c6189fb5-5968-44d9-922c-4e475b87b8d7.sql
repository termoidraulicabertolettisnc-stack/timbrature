-- Add lunch_break_min_hours field to company_settings
ALTER TABLE public.company_settings 
ADD COLUMN lunch_break_min_hours integer DEFAULT 6;

-- Add lunch_break_min_hours field to employee_settings
ALTER TABLE public.employee_settings 
ADD COLUMN lunch_break_min_hours integer DEFAULT NULL;

-- Update the calculate_timesheet_hours function to use configurable minimum hours
...
DECLARE
    ...
    lunch_break_min_hours integer := 6;  -- Default configurable minimum hours
...
BEGIN
    ...
    -- NEW: Determine configurable minimum hours for lunch break application
