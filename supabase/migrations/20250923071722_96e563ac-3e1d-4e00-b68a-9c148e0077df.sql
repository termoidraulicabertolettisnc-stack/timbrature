...
DECLARE
    ...
    session_1_end_time TIMESTAMP WITH TIME ZONE;
    session_2_start_time TIMESTAMP WITH TIME ZONE;
BEGIN
    ...
    RAISE NOTICE 'Migration completed. Fixed timesheets with lunch breaks.';
END $$;