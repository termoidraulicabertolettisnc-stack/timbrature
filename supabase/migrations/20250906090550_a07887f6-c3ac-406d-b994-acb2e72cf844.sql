...
-- Modify employee_settings table to use weekly hours instead of daily hours
ALTER TABLE public.employee_settings 
DROP COLUMN IF EXISTS standard_daily_hours;

ALTER TABLE public.employee_settings 
ADD COLUMN standard_weekly_hours jsonb DEFAULT '{"lun": 8, "mar": 8, "mer": 8, "gio": 8, "ven": 8, "sab": 0, "dom": 0}'::jsonb;

-- Also update company_settings to use weekly hours
...
-- Add absence fields to timesheets table
