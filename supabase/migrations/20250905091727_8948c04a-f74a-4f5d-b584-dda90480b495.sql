-- Add custom lunch duration column to timesheets table
ALTER TABLE public.timesheets 
ADD COLUMN lunch_duration_minutes integer DEFAULT NULL;

-- Update the calculate_timesheet_hours function to use custom lunch duration
...
BEGIN
    ...
    ELSIF NEW.lunch_duration_minutes IS NOT NULL THEN
        -- Usa la durata personalizzata specificata
