-- Restore the missing timesheet trigger for manual entries
-- This is CRITICAL - without this, manual timesheet entries don't get calculated hours
...
CREATE TRIGGER calculate_timesheet_hours_legacy_trigger
