-- Fix employee settings lookup in calculate_timesheet_hours function
...
BEGIN
    ...
    -- FIXED: Get employee settings with corrected NULL-safe WHERE clause
    ...
    IF employee_settings_rec.id IS NOT NULL THEN
    ...
    -- FIXED: Determine lunch break settings with corrected priority
    ...
    -- FIXED: Determine configurable minimum hours for lunch break application
