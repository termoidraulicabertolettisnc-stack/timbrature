-- Corregge l'errore "employee_settings_rec is not assigned yet" nella funzione calculate_hours_on_session_change
...
DECLARE
    ...
    employee_settings_rec record := NULL; -- INIZIALIZZAZIONE ESPLICITA
    company_settings_rec record := NULL; -- INIZIALIZZAZIONE ESPLICITA
...
BEGIN
    ...
    -- CARICA SETTINGS SUBITO ALL'INIZIO
    ...
    LOOP
        ...
        -- Determine night shift times (ora che employee_settings_rec è caricato)
    ...
    -- Update the timesheet record with qualified column names
    UPDATE public.timesheets 
    SET 
