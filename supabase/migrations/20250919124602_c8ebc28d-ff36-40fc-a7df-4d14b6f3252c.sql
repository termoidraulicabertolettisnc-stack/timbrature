-- Correggi il calcolo delle ore notturne considerando il fuso orario locale
...
BEGIN
    ...
    -- FIXED: Calcola ore notturne in orario LOCALE (assumendo UTC+2 per l'Italia)
    -- Converti i timestamp UTC in orario locale (UTC+2)
    local_start_time := (NEW.start_time AT TIME ZONE 'UTC') AT TIME ZONE 'Europe/Rome';
    local_end_time := (NEW.end_time AT TIME ZONE 'UTC') AT TIME ZONE 'Europe/Rome';
